function createDomElements(data) {
  ...
  // This only works when the function has been already called once because before that the DOM is empty
  ...
  data.forEach(function (item) {
    // updated list that may or may not have had a change in state
